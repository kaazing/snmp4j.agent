...
public final class SNMPv2TC implements TCModule {
  ...
  private static Map textualConventions = new HashMap(tcMapping.length);

  static {
    for (int i=0; i<tcMapping.length; i++) {
      textualConventions.put(tcMapping[i][0], tcMapping[i][1]);
    }
  }

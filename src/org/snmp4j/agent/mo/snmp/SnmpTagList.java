/*_############################################################################
  _## 
  _##  SNMP4J-Agent - SnmpTagList.java  
  _## 
...
public class SnmpTagList extends MOMutableColumn {
  ...
  public static Set getTags(OctetString tagList) {
    Collection tags = OctetString.split(tagList, TAG_DELIMITER);
    HashSet list = new HashSet(tags);
    return list;
  }

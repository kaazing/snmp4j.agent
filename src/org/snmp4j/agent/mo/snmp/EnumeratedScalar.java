/*_############################################################################
  _## 
  _##  SNMP4J-Agent - EnumeratedScalar.java  
  _## 
 ...
 * @version 1.2
 */
public class EnumeratedScalar extends MOScalar {

  private EnumerationConstraint constraint;

  /**
   * Creates an enumerated INTEGER scalar with specifying a set of possible
   * values. To constraint the possible values
  ...
  /**
   * Creates a BITS scalar with specifying a set of possible bit
   * values. To constraint the possible values
   * assignable to this object, you will have to set the corrsponding
   * {@link EnumerationConstraint} with {@link #setConstraint} or use an
   * appropriate value validation listener.

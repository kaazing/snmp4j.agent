/*_############################################################################
  _##
  _##  SNMP4J-Agent - NotificationLogMib.java
  _##
  _##  Copyright (C) 2005-2010  Frank Fock (SNMP4J.org)
  _##
...
import org.snmp4j.agent.mo.snmp.NotificationLogMib.NlmLogEntryRow;
import org.snmp4j.agent.mo.snmp.NotificationLogMib.NlmStatsLogEntryRow;
...
//--AgentGen BEGIN=_MEMBERS
  ...
  private List nlmLogEntries = new ArrayList();
...
//--AgentGen END
  ...
  private void createNlmConfigLogEntry(MOFactory moFactory) {
    ...
    nlmConfigLogEntryColumns[idxNlmConfigLogAdminStatus] =
      new Enumerated(colNlmConfigLogAdminStatus,
                     moFactory.createAccess(MOAccessImpl.ACCESSIBLE_FOR_READ_CREATE),
                     new Integer32(1));

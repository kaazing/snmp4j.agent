/*_############################################################################
  _##
  _##  SNMP4J-Agent - ManagedObjectValueAccess.java
  _##
...
public interface ManagedObjectValueAccess extends ManagedObject {
   ...
   *    sucessfully, <code>false</code> otherwise.
   */
  boolean setValue(VariableBinding newValueAndInstancceOID);
}
